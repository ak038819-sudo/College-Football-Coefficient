CREATE TABLE IF NOT EXISTS playoff_field_by_year (
  ...
  pot             INTEGER NOT NULL CHECK (pot IN (0,1,2)),   -- 0=bye,1=pot1,2=pot2
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_field_team_once
  ON playoff_field_by_year(season_year, team_id, formula_version, ruleset);
